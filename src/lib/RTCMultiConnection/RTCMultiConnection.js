    ...
    (function(connection) {
        ...
        function openRoom(callback) {
            ...
            connection.socket.emit('open-room', {
                ...
                maxParticipantsAllowed: connection.maxParticipantsAllowed, // send maxParticipantsAllowed value when open room socket callback(code by https://github.com/wnsvy223)
                password: typeof connection.password !== 'undefined' && typeof connection.password !== 'object' ? connection.password : ''
